<div class="row align-items-center justify-content-center">
    <div class="col-xs-10 col-md-6">
        ...
        <div class="container border d-flex align-items-center flex-column">
            <div class="font-sec w-100 p-4">
                ...
                <div class="ingresar">
                    <p class="font-sec">
                        Ya tienes cuenta? <a href="<?php echo base_url('login_index')?>" class="text-decoration-none color-brown">INGRESÁ AHORA</a>
                    </p>
                </div>
                <?php echo form_close(); ?>
            </div>
