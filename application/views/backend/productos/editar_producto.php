<h4 class="text-center mt-3">MODIFICAR PRODUCTO</h4>
<div class="container border w-50 d-flex align-items-center flex-column">
    <div class="font-sec w-100 p-4">
        ...
        <div class="form-group">
            ...
            <span class="text-danger"><?php echo form_error('descripcionn'); ?> </span>
        </div>
        <div class="form-group">
        ...
        <div class="my-3">
            <?php echo form_submit('actualizar', 'Guardar Cambios', "class='btn  btn-dark btn-brown w-100'"); ?>
        </div>
        <?php echo form_close(); ?>
    </div>
