<div class="home-info d-flex justify-content-center align-items-center flex-column">
    <h1 class="text-white">Envíos gratis en compras superiores a $10.000</h1>
    <p class="text-white font-sec">Arandú ofrenciendo a sus clientes siempre productos de la mejor calidad y al mejor
        precio.</p>
    <div class="banner-botones d-flex w-50">
        <i class="mx-3"></i>
